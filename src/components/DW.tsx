...
const DW = () => {
  ...
  return (
    <div className="px-5 -ml-4 lg:w-1/3 w-full">
    <div className="mx-auto w-7/8 overflow-x-auto font-mono">
        <div className="container p-4 mx-auto bg-back1-b2 rounded-lg">

            <div className="flex lg:w-3/5 mx-auto flex-row justify-center">
                    <ul className="flex items-center text-center ">
                        <a href="#" className="rounded-l-lg border-blue1-light border-2 px-9 py-2 transition">Deposit</a>
                        <a href="#" className="rounded-r-lg border-blue1 border-t-2 border-r-2 border-b-2 px-9 py-2 transition text-gray1-g50 hover:text-white">Withdraw</a>
                    </ul>
            </div>

            <div className="flex w-full mx-auto flex-row justify-left pt-3">
                <h1 className="flex pl-1 pr-2">Amounts</h1>
            ...
            <div className="flex w-full mx-auto flex-row justify-left pt-4">
            ...
            <div className="flex w-full mx-auto flex-row justify-center pt-8">
